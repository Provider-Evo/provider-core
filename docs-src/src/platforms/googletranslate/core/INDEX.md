# googletranslate/core 模块

Google Translate 平台的核心实现，包含适配器核心逻辑和客户端。
...
├── client.py        # Google Translate API 客户端
└── constants.py     # 常量定义
```

## 核心类

### GoogleTranslateAdapter (adaptercore.py)

继承自 `PlatformAdapter`，实现 Google Translate API 的具体逻辑。

**主要方法：**
- `name`: 返回平台标识 "googletranslate"
