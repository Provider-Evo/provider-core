...
# ---------------------------------------------------------------------------
# Proxy pool configuration (from opencode)
# ---------------------------------------------------------------------------
...
PROXY_REFRESH_INTERVAL: int = 86400

PROXY_SCORE_PERSIST_PATH: str = "persist/zen/proxy_score.json"
PROXY_POOL_PERSIST_PATH: str = "persist/zen/proxy_pool.json"
