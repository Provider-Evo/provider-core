...
def make_not_supported(feature: str) -> Callable[[aiohttp.web.Request], aiohttp.web.Response]:
...
def make_empty_list(_object: str = "list") -> Callable[[aiohttp.web.Request], aiohttp.web.Response]:
    async def handler(_request: aiohttp.web.Request) -> aiohttp.web.Response:
...
def make_not_found(resource: str) -> Callable[[aiohttp.web.Request], aiohttp.web.Response]:
    async def handler(_request: aiohttp.web.Request) -> aiohttp.web.Response:
