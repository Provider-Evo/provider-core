...
PY_REPLACEMENTS: tuple[tuple[str, str], ...] = (
    ...
    ("from src.core.server.app_host", "from src.core.server.lifecycle.app_host"),
    ("from src.core.server.app import", "from src.core.server.lifecycle.app import"),
    ...
    ("from src.core.auth", "from src.core.server.auth"),
    ("from src.core.http_errors", "from src.core.errors.http_errors"),
    ("from src.webui.services", "from src.webui.data.services"),
