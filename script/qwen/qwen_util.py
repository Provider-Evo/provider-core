...
class ServerConfig:
    ...
    ANTHROPIC_MODEL_MAPPING: Dict[str, str] = {
        ...
        "claude-3-haiku-20240307": "qwen3-omni-flash-2025-12-01",
        "claude-3-5-sonnet-20240620": "qwen-plus-2025-07-28",
        "claude-3-5-sonnet-20241022": "qwen3-coder-plus",
        "claude-3-5-haiku-20241022": "qwen3-vl-plus",
        "claude-sonnet-4-20250514": "qwen3-coder-plus",
        "claude-sonnet-4-5-20250929": "qwen3-coder-plus",
        "claude-opus-4-5-20251101": "qwen3-max-2026-01-23",
        "claude-opus-4-6": "qwen3.5-plus",
    }
