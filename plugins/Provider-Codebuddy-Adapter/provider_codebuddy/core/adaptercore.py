...
- 模块路径：provider-plugin.Provider-Codebuddy-Adapter.provider_codebuddy.core.adaptercore
- 文件名：adaptercore.py
- 父包：provider-plugin/Provider-Codebuddy-Adapter/provider_codebuddy/core
